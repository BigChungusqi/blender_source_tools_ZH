...
class SmdImporter(bpy.types.Operator, Logger):
	...
	filepath : StringProperty(name=get_id("importer_filepath"), description="File filepath used for importing the SMD/VTA/DMX/QC file", maxlen=1024, default="", options={'HIDDEN'})
	files : CollectionProperty(type=bpy.types.OperatorFileListElement, options={'HIDDEN'})
	directory : StringProperty(maxlen=1024, default="", subtype='FILE_PATH', options={'HIDDEN'})
	filter_folder : BoolProperty(name=get_id("importer_filter_folders"), description="", default=True, options={'HIDDEN'})
	...
	append : EnumProperty(name=get_id("importer_bones_mode"),description=get_id("importer_bones_mode_desc"),items=(
		...
		default='APPEND')
	upAxis : EnumProperty(name=get_id("importer_up_axis_name"),items=axes,default='Z',description=get_id("importer_up_tip"))
	...
	boneMode : EnumProperty(name=get_id("importer_bonemode"),items=(('NONE',get_id("importer_bonemode_default"),''),('ARROWS',get_id("importer_bonemode_arrows"),''),('SPHERE',get_id("importer_bonemode_sphere"),'')),default='SPHERE',description=get_id("importer_bonemode_tip"))
